...
<head lang="en">
    ...
    <meta name="description" content="Shopping in Hanmer Springs, New Zealand accommodation">
    <title>Hanmer Springs, New Zealand Shopping</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-7">
            <h1>Shopping in Hanmer Springs</h1>
            <p class="lead">Explore the many shops that Hanmer Springs.</p>
            <div class="row" id="categories">
                ...
                <div class="col-md-12">
                    <h5>Books, Gift, Souvenirs &amp; Crafts</h5>
                    <img src="http://placehold.it/200x120" alt="" class="img-responsive pull-left">
                    <p></p>
                </div>
                <div class="col-md-12">
