...
<head lang="en">
    ...
    <meta name="description" content="Art Galleries in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Shopping: Art Galleries</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Art Galleries</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Shopping in Hanmer Springs: Art Galleries</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
