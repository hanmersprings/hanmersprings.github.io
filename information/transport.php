...
<head lang="en">
    ...
    <meta name="description" content="Hanmer Springs, New Zealand Transport Information">
    <title>Getting to and around Hanmer Springs, New Zealand</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Getting Here &amp; Around</li>
        </ol>
    </div>

    <div class="row">
        <div class="col-md-12">
            <h1>Getting to Hanmer Springs, New Zealand</h1>
        </div>
    </div>

    <div class="row">
        <div class="col-md-9">
            <p class="lead">Getting to Hanmer Springs and exploring once you are here is easy, with a wide selection of transport options.</p>
        </div>
        <div class="col-md-3">
