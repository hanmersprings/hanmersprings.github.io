...
<head lang="en">
    ...
    <meta name="description" content="Nature &amp; Ecotourism activities in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Activities: Nature &amp; Ecotourism</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Nature &amp; Ecotourism</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Hanmer Springs Activities: Nature &amp; Ecotourism</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
