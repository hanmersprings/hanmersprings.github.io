...
<head lang="en">
    ...
    <meta name="description" content="Takeaways in Hanmer Springs, New Zealand">
    <title>Dining out in Hanmer Springs: Takeaways</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Dining out in Hanmer Springs: Takeaways</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
