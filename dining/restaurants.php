...
<head lang="en">
    ...
    <meta name="description" content="Restaurants in Hanmer Springs, New Zealand">
    <title>Dining out in Hanmer Springs: Restaurants</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Dining out in Hanmer Springs: Restaurants</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
