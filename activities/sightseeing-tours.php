...
<head lang="en">
    ...
    <meta name="description" content="Sightseeing Tours in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Activities: Sightseeing Tours</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Sightseeing Tours</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Hanmer Springs Activities: Sightseeing Tours</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
