...
<head lang="en">
    ...
    <meta name="description" content="Sports Activities in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Activities: Sports</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Hanmer Springs Activities: Sports</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
