...
<head lang="en">
    ...
    <meta name="description" content="Cafés in Hanmer Springs, New Zealand">
    <title>Dining out in Hanmer Springs: Cafés</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Cafés</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Dining out in Hanmer Springs: Cafés</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
