...
<head lang="en">
    ...
    <meta name="description" content="Clothing shops in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Shopping: Clothes</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Shopping in Hanmer Springs: Clothing</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
