...
<head lang="en">
    ...
    <meta name="description" content="Food &amp; Liquor Shops in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Shopping: Food &amp; Liquor</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Food &amp; Liquor Shops</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Shopping in Hanmer Springs: Food &amp; Liquor</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
