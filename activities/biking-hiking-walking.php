...
<head lang="en">
    ...
    <meta name="description" content="Biking, Hiking &amp; Walking in Hanmer Springs, New Zealand">
    <title>Hanmer Springs Activities: Biking, Hiking &amp; Walking</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Biking, Hiking &amp; Walking</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Hanmer Springs Activities: Biking, Hiking &amp; Walking</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
