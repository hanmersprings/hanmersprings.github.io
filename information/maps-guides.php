...
<head lang="en">
    ...
    <meta name="description" content="Maps, Guides and more for Hanmer Springs, New Zealand">
    <title>Maps &amp; Guides for Hanmer Springs, New Zealand</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Maps &amp; Guides</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1>Hanmer Springs Maps &amp; Guides</h1>
            <p class="lead"></p>
