...
<head lang="en">
    ...
    <meta name="description" content="Art, Culture &amp; Heritage in Hanmer Springs, New Zealand.">
    <title>Hanmer Springs Activities: Art, Culture &amp; Heritage</title>
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Art, Culture &amp; Heritage</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Hanmer Springs Activities: Art, Culture &amp; Heritage</h1>
            <p class="lead"></p>
        </div>
    </div>
    <div class="row">
